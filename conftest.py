...
class FakeTracker:
    ...
    It matches names the way the contract describes. It cannot prove ordering,
    because it is the same code asserting and answering; only a real tracker
    can.
    """
...
def tracker() -> FakeTracker:
    ...
    return FakeTracker(
        assets=(
            Asset(id="7701", name="Frying Pan", kind="Prop"),
            Asset(id="7702", name="Pan Lid", kind=None),
            Asset(id="7703", name="Kitchen Counter", kind="Set Piece"),
        ),
        shots=(
